...
const MAX_RAW_HEARTBEATS = 500; // per monitor, kept for recent response-time charts
const MAX_DAILY_DAYS = 90; // status page never needs more than this
const MAX_HOURLY_HOURS = 50; // enough to cover a rolling 24h window plus "today since midnight" near a day boundary
const MAX_EVENTS = 200; // per monitor, kept for the incident/event history log
